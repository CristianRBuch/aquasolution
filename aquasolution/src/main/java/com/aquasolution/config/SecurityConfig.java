    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/img/**", "/registro", "/recuperar/**").permitAll()
                        ...
                        .requestMatchers("/cotizaciones/pdf/**").hasAnyAuthority("ADMIN", "TECNICO", "CLIENTE")
                        .requestMatchers("/cotizaciones/**").hasAuthority("ADMIN")
                        .requestMatchers("/reportes/pdf/**").hasAnyAuthority("ADMIN", "TECNICO", "CLIENTE")
                        .requestMatchers("/reportes/**").hasAnyAuthority("ADMIN", "TECNICO")
                        .requestMatchers("/dosificaciones/pdf/**").hasAnyAuthority("ADMIN", "TECNICO", "CLIENTE")
                        .requestMatchers("/dosificaciones/**").hasAnyAuthority("ADMIN", "TECNICO")
                        ...
                        .requestMatchers("/auditoria/**").hasAuthority("ADMIN")
